...
import { BiCommand, BiStar } from "react-icons/bi";
          ...
          <div className="relative bg-[#12121a]/90 border border-gray-800/50 backdrop-blur-2xl rounded-2xl p-12">
            ...
            <div className="relative">
              <div className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-purple-500/10 to-blue-500/10 mb-6 ring-1 ring-gray-800/60">
                <BiStar className="w-8 h-8 text-purple-400" />
              </div>
              ...
              >
                <BiCommand className="w-5 h-5 text-blue-400" />
                <span>Open Editor</span>
                <BsArrowRight className="w-5 h-5 text-purple-400 group-hover:translate-x-0.5 transition-transform" />
              </Link>
            </div>
          </div>
        </div>
