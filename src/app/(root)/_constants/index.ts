...
export const LANGUAGE_CONFIG: LanguageConfig = {
  javascript: {
    ...
    pistonRuntime: { language: "javascript", version: "18.15.0", judgeId: 63 },
...
console.log('Sum of numbers:', sum);`,
  ...
  typescript: {
    ...
    pistonRuntime: { language: "typescript", version: "5.0.3", judgeId: 74 },
...
console.log('Sum of numbers:', math.sum());`,
  ...
  python: {
    ...
    label: "Python",
    logoPath: "/python.png",
    pistonRuntime: { language: "python", version: "3.10.0", judgeId: 71 },
...
print(f"Sum of numbers: {numbers_sum}")`,
  ...
  java: {
    ...
    label: "Java",
    logoPath: "/java.png",
    pistonRuntime: { language: "java", version: "15.0.2", judgeId: 62 },
    monacoLanguage: "java",
  ...
  go: {
    ...
    label: "Go",
    logoPath: "/go.png",
    pistonRuntime: { language: "go", version: "1.16.2", judgeId: 22 },
    monacoLanguage: "go",
...
func main() {
  ...
  rust: {
    ...
    label: "Rust",
    logoPath: "/rust.png",
    pistonRuntime: { language: "rust", version: "1.68.2", judgeId: 73 },
    monacoLanguage: "rust",
    defaultCode: `fn main() {
    // Create vector
  ...
  cpp: {
    ...
    label: "C++",
    logoPath: "/cpp.png",
    pistonRuntime: { language: "cpp", version: "10.2.0", judgeId: 53 },
    monacoLanguage: "cpp",
...
int main() {
  ...
  csharp: {
    ...
    label: "C#",
    logoPath: "/csharp.png",
    pistonRuntime: { language: "csharp", version: "6.12.0", judgeId: 51 },
...
class Program {
  ...
  ruby: {
    ...
    label: "Ruby",
    logoPath: "/ruby.png",
    pistonRuntime: { language: "ruby", version: "3.0.1", judgeId: 72 },
    monacoLanguage: "ruby",
...
puts "Sum of numbers: #{sum}"`,
  ...
  swift: {
    ...
    label: "Swift",
    logoPath: "/swift.png",
    pistonRuntime: { language: "swift", version: "5.3.1", judgeId: 83 },
...
export const THEMES: Theme[] = [
  ...
  { id: "midnight-ocean", label: "Midnight Ocean", color: "#011627" },
  { id: "solarized-light", label: "Solarized Light", color: "#fdf6e3" },
  { id: "cyberpunk-glow", label: "Cyberpunk Glow", color: "#0f172a" },
];
...
export const THEME_DEFINITIONS = {
  "midnight-ocean": {
    ...
    colors: {
      ...
      "editorIndentGuide.background": "#2c4251",
    },
  },
  "solarized-light": {
    base: "vs",
  ...
  "cyberpunk-glow": {
    ...
    rules: [
      ...
      { token: "variable", foreground: "ff9e00" },
      { token: "function", foreground: "ffdd00" },
      { token: "type", foreground: "9a79f7" },
    ],
    colors: {
      ...
      "editorIndentGuide.background": "#2e3a59",
    },
  },
};
