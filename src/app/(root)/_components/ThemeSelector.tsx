      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-full min-w-[240px] bg-[#1e1e2e]/95 backdrop-blur-xl rounded-xl border border-[#313244] sbadow-2xl py-2 z-50"
          >
            ...
            {THEMES.map((t, index) => {
              return (
                <motion.button
                  ...
                  className={`relative group w-full flex items-center gap-3 px-3 py-2 hover:bg-[#262636] rounded-xl duration-200 ${t.id == theme ? "bg-blue-500/10 text-blue-400 border border-blue-400" : "text-gray-300"}`}
